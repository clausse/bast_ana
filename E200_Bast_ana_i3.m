% Script to analyze butterfly from E200 2013 data with QS energy = 0 GeV
...
data_set = 'E200_10809';
do_save = 0;
save_path = ['C:/Users/Bastien/Desktop/PRE/Matlab/2013_E200_Data_Analysis/Argon_/Zoom_Butterfly_setQSenergy=0GeV/' day '/'];
...
%         div = text(0.15,4.,['\Theta = ' num2str(1000000*theta) ' \murad' ], 'fontsize', 20, 'color', 'b');
...
%         set(emittance,'String',['\epsilon < ' num2str(emit) ' microns']);
        ...
        set(fig_celoss_slice,'YData',[xzoom_min xzoom_max],'CData',CELOSS.slice');
...
%         set(parabola_fit,'XData',x2,'YData',y2);
    ...
    %%   SAVING IN EACH LOOP
     if do_save           
         filename = ['frame_' num2str(i, '%.2d') '_' num2str(j, '%.3d') '_' num2str(nb_slice) 'largewindow.png'];
