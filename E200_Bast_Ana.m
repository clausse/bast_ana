% Script to analyze butterfly from E200 2013 data
...
data_set = 'E200_10809';
do_save = 0;
save_path = ['C:/Users/Bastien/Desktop/PRE/Matlab/2013_E200_Data_Analysis/Rubidium_density=2.7e17_halfpyro/' day '/'];
...
%     CELOSS.zoom = CELOSS.img2(yzoom_min:yzoom_max, xzoom_min:xzoom_max);
...
LeftAxes2 = axes('position', [0.37, 0.065, 0.22, 0.39]);         % affichage du zoom sur butterfly de CELOSS.slice
        fig_celoss_slice = image(CELOSS.yyzoom,xzoom_min:xzoom_max,log10(CELOSS.slice'),'CDataMapping','scaled');
        colormap(cmap.wbgyr);
        axis xy;
%         caxis(CELOSS_caxis);
