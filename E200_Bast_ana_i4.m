% Script to analyze butterfly from E200 2013 data with QS energy = +4 GeV
...
[~,ind]=ismember(min((E_EGAIN-(12.35)).^2),(E_EGAIN-(12.35)).^2);
    xzoom_min = ind -100;
    xzoom_max = ind +19;
...
%  T = (thetamoy(2)+thetamoy(3)+thetamoy(4)+thetamoy(5)+thetamoy(6)+thetamoy(7)+thetamoy(10)+thetamoy(11)+thetamoy(17)+thetamoy(18)+thetamoy(19)+thetamoy(21)+thetamoy(22)+thetamoy(23)+thetamoy(24)+thetamoy(28)+thetamoy(30)+thetamoy(32)+thetamoy(33)+thetamoy(34)+thetamoy(35)+thetamoy(37)+thetamoy(39)+thetamoy(45)+thetamoy(46))/25;
% end
